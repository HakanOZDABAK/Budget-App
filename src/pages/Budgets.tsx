                ...
                content={({ hide }) => (
                    <div className="flex flex-column px-8 py-5 gap-4" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
                        ...
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="inputValue" className="text-primary-50 font-semibold">
                                Value
                            </label>
                            <InputText id="inputValue" aria-label="InputValue" className="bg-white-alpha-20 border-none p-3 text-primary-50" onChange={(e)=>e.target.value}></InputText>
                        </div>

                        <div className="flex align-items-center gap-2">
                            <Button label="Update" onClick={()=>{handleUpdateData(inputData,token)}} text className="p-3 w-full text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10"></Button>
                        </div>
                    </div>
                )}
            ></Dialog>
